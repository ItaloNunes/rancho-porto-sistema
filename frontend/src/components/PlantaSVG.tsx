...
import type { CondominioDetalhe, Lote, LoteStatus } from "../types";
 ...
 * os botões +/- para dar zoom, clique em um lote para abrir o detalhe. */
export default function PlantaSVG({ condo, selecionado, onSelecionar }: Props) {
  ...
  function fit() {
    ...
    setPan({ x: (el.clientWidth - planW * s) / 2 - planMinX * s, y: 20, scale: s });
  }
  ...
  return (
    <div className="card overflow-hidden">
      <div className="relative">
        ...
        <div
          ref={viewportRef}
          className={`h-[62vh] min-h-[380px] max-h-[640px] bg-surface-alt/40 overflow-hidden touch-none select-none
      ...
      <p className="text-xs text-ink-soft px-5 py-3 border-t border-border">
        Arraste para navegar, use o scroll (ou os botões) pra dar zoom. Toque em um lote pra ver os detalhes.
      </p>
    </div>
  );
}
